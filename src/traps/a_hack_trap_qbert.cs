...
namespace Underworld
{
    ...
    public class a_hack_trap_qbert : hack_trap
    {
        ...
        private static void StepOnPyramidTile()
        {
            ...
            int var8 = 0;
            var currentTile = UWTileMap.current_tilemap.Tiles[playerdat.playerObject.tileX, playerdat.playerObject.tileY];
        ...
        private static void TeleportToLocation(int owner)
        {
            ...
            while (counter <= 4)
            {
                ...
                {
                    if ((Math.Abs(teleportX - playerdat.playerObject.tileX) >= 3) || (Math.Abs(teleportY - playerdat.playerObject.tileY) >= 3))
